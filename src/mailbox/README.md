...
- Build on top of the powerful Finite State Machine (FSM) with [XState](https://xstate.js.org/) library.
...
![XState Mailbox Actor Architecture Diagram](mailbox-actor-arch.svg)]
